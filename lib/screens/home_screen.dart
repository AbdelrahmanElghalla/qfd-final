...
import 'package:qfd/services/PostService.dart';
import 'package:qfd/services/auth.dart';
import 'package:qfd/widgets/post.dart';
import 'add_post.dart';
import 'package:firebase_database/ui/firebase_animated_list.dart';
import 'package:firebase_database/firebase_database.dart';
import 'package:qfd/screens/viewPost.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("QFD Designers Community"),
  ...
  _childAdded(Event event) {
    setState(() {
     ...
     // addPostComment(Post.fromSnapshot(event.snapshot).key);
    });
  }
